...
:: 1. Verify requirements.txt exists inside the src folder (Wrapped variables in quotes to handle spaces)
...
:: 3. Run pip install using --quiet flags and safe string wrapping
